...
public class ProductRepositoryTests {
	...
	public void testCreateProduct() {
		...
		product.setName("MSI Pretige 14");
		product.setAlias("msi_pretige_14");
		product.setShortDescription("Short description for MSI Pretige 14");
		product.setFullDescription("Full description for MSI Pretige 14");
